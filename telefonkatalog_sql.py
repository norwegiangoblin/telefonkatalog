...
def printMeny():
    ...
    print("| 4. Fjern person fra katalog                        |")
    print("| 5. Avslutt                                         |")
    print("------------------------------------------------------")
...
def utfoerMenyvalg(valgtTall):
    if valgtTall == "1":
        ...
        bekreftelse = input("Er du sikker på at du vil fjerne " + fornavn + " fra katalogen? J/N ")
        if (bekreftelse == "J" or bekreftelse == "j"):
            slett_person_fra_db(fornavn, etternavn, telefonnummer)
            print(fornavn + " har blitt fjernet fra katalogen")
            printMeny()
        else:
            print(fornavn + " ble ikke fjernet")
            printMeny()
    elif valgtTall == "5":
